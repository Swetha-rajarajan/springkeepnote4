...
public class KeepNoteDataSource {
	 ...
	 * dataSource; }
	 */
	//use this configuration while submitting in hobbes.
 ...
 @Bean public DataSource dataSource() { 
	  ...
	  dataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
	  dataSource.setUrl("jdbc:mysql://localhost:3306/hclaniyalDB?createDatabaseIfNotExist=true&useSSL=false&allowPublicKeyRetrieval=true");
